package com.wlazy.core.http.ssl;
...
public class DefaultHttpsFactroy {
    ...
    public static SSLSocketFactory creatSSLSocketFactory(Context context, String name) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("Novate", "SSLSocketFactory open file error :" + e.toString());
        }
        try {
            certificateFactory = CertificateFactory.getInstance("X.509");
            ...
            Log.e("Novate", "SSLSocketFactory generate error :" + e.toString());
        }
        return null;
    }
